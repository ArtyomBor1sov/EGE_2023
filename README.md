...
#РЕЗУЛЬТАТ РАБОТЫ ПРОГРАММЫ - 149
```

## №7 - Определение результатов работы простейших алгоритмов (Черепашка)

## №8 - Определение результатов работы простейших алгоритмов (Черепашка)

## №9 - Определение результатов работы простейших алгоритмов (Черепашка)

## №10 - Определение результатов работы простейших алгоритмов (Черепашка)

## №11 - Определение результатов работы простейших алгоритмов (Черепашка)

## №12 - Определение результатов работы простейших алгоритмов (Черепашка)

## №13 - Определение результатов работы простейших алгоритмов (Черепашка)

## №14 - Определение результатов работы простейших алгоритмов (Черепашка)

## №15 - Определение результатов работы простейших алгоритмов (Черепашка)

## №16 - Определение результатов работы простейших алгоритмов (Черепашка)

## №17 - Определение результатов работы простейших алгоритмов (Черепашка)

## №18 - Определение результатов работы простейших алгоритмов (Черепашка)

## №19 - Определение результатов работы простейших алгоритмов (Черепашка)

## №20 - Определение результатов работы простейших алгоритмов (Черепашка)

## №21 - Определение результатов работы простейших алгоритмов (Черепашка)

## №22 - Определение результатов работы простейших алгоритмов (Черепашка)

## №23 - Определение результатов работы простейших алгоритмов (Черепашка)

## №24 - Определение результатов работы простейших алгоритмов (Черепашка)

## №25 - Определение результатов работы простейших алгоритмов (Черепашка)

## №26 - Определение результатов работы простейших алгоритмов (Черепашка)

## №27 - Определение результатов работы простейших алгоритмов (Черепашка)